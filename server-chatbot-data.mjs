// Server-side version of chatbot data for use in Vercel server functions
// Extracted from chatbot-data.js but exported as an ES module (no window references)
